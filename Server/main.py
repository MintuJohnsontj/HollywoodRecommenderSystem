...
def get_recomendations(m):
    m = m.lower()
    data, similarity = similarity_score()
    if m not in data['movie_title'].unique():
        return 'Sorry! Movie not found. Plz check the spelling!!'
    else:
...
def convert_to_list(my_list):  # converting list of string to list(eg: "["abc","def"]" to ["abc","def"])
...
def recommend():
    ...
    # so that it can be processed easily and the order of information will be preserved
